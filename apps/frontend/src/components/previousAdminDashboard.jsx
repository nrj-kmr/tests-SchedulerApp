...
const AdminDashboard = () => {
  ...
  const getUsers = () => axios.get('http://localhost:8000/api/admin/getUsers').then((response) => setUsers(response.data)).catch((err) => console.error('error fetching users', err))

  const getTests = () => axios.get('http://localhost:8000/api/admin/getTests')
    .then((response) => {
